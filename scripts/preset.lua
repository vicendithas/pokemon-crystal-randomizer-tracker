...
function Preset:onLeftClick()
	...
	if	self.code == "full_nightmare"				then	presetSettings = {	true,	false,	true,	true,	true,	true,	true,	true,	true,	true,	true,	true}	end
	if	self.code == "full_chaos_nightmare"			then	presetSettings = {	true,	true,	true,	true,	true,	true,	true,	true,	true,	true,	true,	true}	end
